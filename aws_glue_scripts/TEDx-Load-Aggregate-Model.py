...
##### FROM FILES
tedx_dataset_path = "s3://unibg-tedx-data-2023-test/tedx_dataset.csv"
...
## READ TAGS DATASET
tags_dataset_path = "s3://unibg-tedx-data-2023-test/tags_dataset.csv"
...
mongo_uri = "mongodb+srv://xxxx:xxxx@xxxxxxxxxxxx"
print(mongo_uri)
